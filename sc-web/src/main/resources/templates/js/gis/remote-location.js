define(["require", "exports", "avalon"], function (require, exports, avalon) {
    ...
    var mapVM = avalon.define({
         ...
         * @func 回调函数
         */
        createTimer: function (period, func) {
            var $this = this;
    ...
    var _privUtils = {
        ...
        MAP: {
             ...
             * 注册远程位置监听
             */
            regRemoteLocation: function (notify) {
                var geolocation = _privUtils.CACHE.geolocation;
                var map = _privUtils.CACHE.map;
